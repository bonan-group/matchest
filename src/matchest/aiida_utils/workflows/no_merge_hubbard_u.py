...
Needs to adapated for aiida-vasp 5.0 !
"""
...
from aiida_vasp.common.opthold import (
    DictOption,
    IntOption,
    ListOption,
    OptionContainer,
)
from aiida_vasp.common.repository import open_compressed


class LinearResponseUOptions(OptionContainer):
    """Container for settings of the linear response U workchain"""

    l = IntOption("Angular momentum channel", 2)  # noqa: E741
...
class LinearResponseU(WorkChain):
    ...
    def define(cls, spec):
        ...
        spec.input(
            ...
            serializer=LinearResponseUOptions.serialize,
    ...
    def do_responses(self):
        ...
        self.report("All response calculations have been submitted")
