...
from aiida_vasp.common.misc import get_energy_from_misc
...
def compose_delithiation_data(**miscs):
    ...
    for _, misc in miscs.items():
        ...
        misc_dict = workchain.outputs.misc.get_dict()
        miscs[link_name] = misc_dict  # Record the misc nodes for linking
        magnetisation = misc_dict.get("magnetization", [])
        ...
        energy = get_energy_from_misc(misc_dict) / num_fu
