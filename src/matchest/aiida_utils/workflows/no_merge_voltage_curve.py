...
1. Identify the *delithiatable* part of the composition
2. Generate unique delithiated structures, up to a certain supercell size (given as inputs)
...
NOTE: This workflow needs to be adapated for aidia-vasp 5.0!
"""
...
class VoltageCurveWorkChain(WorkChain, WithVaspInputSet):
    ...
    def define(cls, spec):
        ...
        spec.input(
            ...
            valid_type=orm.Dict,
            serializer=EwaldFilterOptions.serialize,
            required=False,
